...
export const constantRoutes = [
    ...
    children: [
      {
        ...
        path: 'workOrderList',
        name: 'workOrderList',
        component: () => import('@/views/order/workOrderIndex'),
  ...
  },
  {
    path: '/workers',
    component: Layout,
    redirect: '/workers/workersManage',
    name: 'workers',
    meta: { title: '工人管理', icon: 'el-icon-s-help' },
    children: [
      {
        path: 'workersManage',
        name: 'workersManage',
        component: () => import('@/views/workers/index'),
        meta: { title: '工人管理', icon: 'table' }
      }
    ]
  },
  {
